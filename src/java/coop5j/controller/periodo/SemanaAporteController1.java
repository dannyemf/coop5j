...
@Named(value = "semApoController1")
@ConversationScoped
public class SemanaAporteController1 extends AbstractController{
    ...
    public SemanaAporteController1() {
    }
    ...
    public String eventoAdmAportes(Semana item){
        ...
        for (Iterator<Cuenta> it = listaCuentas.iterator(); it.hasNext();) {
            ...
            if(as == null){
                as = new AporteSemanal(item, modeloEdicion, cc);
                service.save(as);
            }
            listaAportes.add(as);
        }
